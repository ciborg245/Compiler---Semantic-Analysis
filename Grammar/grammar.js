...
var grammar = {
    ...
    {"name": "expression", "symbols": ["location"]},
    {"name": "expression", "symbols": ["literal"]},
    {"name": "expression", "symbols": ["term"]},
    {"name": "expression", "symbols": ["expression", "arith_op", "term"]},
    {"name": "expression", "symbols": ["expression", "rel_op", "term"]},
    {"name": "expression", "symbols": ["expression", "eq_op", "term"]},
    {"name": "expression", "symbols": ["expression", "cond_op", "term"]},
    {"name": "expression", "symbols": [{"literal":"-"}, "expression"]},
    {"name": "expression", "symbols": [{"literal":"!"}, "expression"]},
    ...
    {"name": "term", "symbols": ["term", "arith_high_op", "factor"]},
    {"name": "term", "symbols": ["term", {"literal":"&&"}, "factor"]},
    {"name": "factor", "symbols": ["int_literal"]},
    {"name": "factor", "symbols": [{"literal":"("}, "expression", {"literal":")"}]},
    {"name": "factor", "symbols": ["location"]},
    {"name": "factor", "symbols": ["bool_literal"]},
    {"name": "factor", "symbols": ["methodCall"]}
]
  , ParserStart: "program"
}
